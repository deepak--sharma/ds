                        ...
                        if (dr != null && dr.HasRows)
                        {
                            while (dr.Read())
                            {
                                var emp = new Employee()
                                {
                                    ...
                                    {
                                        MonthlyGross = dr["MonthlyGross"] == DBNull.Value || dr["MonthlyGross"] == null ? 0 : decimal.Parse(dr["MonthlyGross"].ToString())
                                    },
                                    Attendance = new EmpAttendance
                                    {
                                        TotalDays = dr["TotalDays"] == DBNull.Value || dr["TotalDays"] == null ? 0 : long.Parse(dr["TotalDays"].ToString()),
                                        LeaveDays = dr["LeaveDays"] == DBNull.Value || dr["LeaveDays"] == null ? 0 : long.Parse(dr["LeaveDays"].ToString()),
                                        WorkDays = dr["WorkDays"] == DBNull.Value || dr["WorkDays"] == null ? 0 : long.Parse(dr["WorkDays"].ToString()),
